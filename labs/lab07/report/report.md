...
вариантов заданий, наш номер - 14, полученный при выполнении лабораторной работы. Создали исполняемый файл и проверили его
работу для значений 𝑥1 и 𝑥2 из таблицы 7.3. (рис. [-@fig:022]).
